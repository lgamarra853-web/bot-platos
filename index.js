...
const MENSAJES = {
  manana: (n) => '☀️ *¡Buenos días, ' + n + '!* Paso a recordarte que hoy te toca lavar los platos. 🍽️',
  tarde:  (n) => '🌤️ *¡Buenas tardes, ' + n + '!* No te olvides que los platos de hoy son tu responsabilidad. 😊',
